...
class LoadImages:
    ...
    def __init__(self, path, img_size=640, stride=32, auto=True, cap=None):
        ...
        self.count = 0
        if any(videos):
            self.new_video(videos[0],cap)  # new video
        else:
            self.cap = None
